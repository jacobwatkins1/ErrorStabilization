...
if __name__=='__main__':
    ...
    print(os.getpid())
    e_stab,vsmall_stab = main.stabilize(nmat_start,hmat_start,autotune=autotune,errsizeN=errsize_nmat,errsizeH=errsize_hmat,verbose=True)
    print(os.getpid())
    
    
    
    print('N condition number:',np.linalg.cond(nmat_start))
    print('H condition number:',np.linalg.cond(hmat_start))
    print('',flush=True)
    print("Overlap of...")
